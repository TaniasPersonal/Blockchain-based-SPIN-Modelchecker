...
tt_predef_np(void)
{
	...
	fprintf(tt, "(Trans **) emalloc(3*sizeof(Trans *));\n");
...
{	ProcList *p;
	...
	if (ethereum){
		fprintf(th, "#define ethereum 1\n" );
	}
	else{
		fprintf(th, "#define ethereum 0\n" );
	}
